...
import sd.rittal.qrsdk.BuildConfig;

public class RetrofitBuilder {

    private static Retrofit retrofit = null;
    private static final String BASE_URL = "";
    private static final String API_VERSION = BuildConfig.BUILD_TYPE;
...
//        try {
//            sslContext = createCertificate(context.getResources().openRawResource(R.raw.client_certificate));
